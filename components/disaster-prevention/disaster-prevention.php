<?php
$disaster_prevention_database01 = [
    [
...
$disaster_prevention_database02 = [
    [
        "heading" => "いつも人の目が守る<br>24時間有人管理",
        "detail" => "24時間係員が常駐する防災センターを設置。また、火災、ガス漏れ・防犯など、万が一の際は異常信号を「三井不動産レジデンシャルサービス（お客様センター）」「綜合警備保障（ALSOK）」へ自動通報します。",
        "notice" => "※内外部のインフラ状況等により使用できない場合があります。",
        "image" => "disaster-prevention/disaster-prevention/alsok.jpg",
        "image-width" => "308",
        "image-height" => "208",
        "sub-image" => ""
    ],
    [
        "heading" => "不審者のとも連れを抑止<br>ダブルオートロック",
        "detail" => "メインエントランスには、居住者や来訪者と共に入館する侵入手口を抑止する、ダブルオートロック方式のカメラ付オートロック操作盤を設置しています。",
        "notice" => "",
        "image" => "disaster-prevention/disaster-prevention/emergency-power.jpg",
        "image-width" => "308",
        "image-height" => "208",
    ...
    [
        "heading" => "ベルボーイ",
        "detail" => "テキストテキストテキストテキストテキストテキストテキストテキストテキスト
        テキストテキストテキストテキストテキストテキストテキストテキストテキスト",
        "notice" => "",
        "image" => "disaster-prevention/disaster-prevention/bellboy.jpg",
        "image-width" => "308",
        "image-height" => "208",
        "sub-image" => ""
    ],
...
$disaster_prevention_database03 = [
    [
        "heading" => "対策本部を構成",
        "detail" => "管理組合、自治会、防災ボランティア、管理会社、地域といった...テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト<br><br><a href>＞＞テキストリンク</a>",
        "notice" => "",
        "image" => "disaster-prevention/disaster-prevention/emergency-power.jpg",
        "image-width" => "308",
        "image-height" => "208",
    ...
    [
        "heading" => "防災区民組織",
        "detail" => "テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト<br><br><a href>＞＞テキストリンク</a>",
        "notice" => "",
        "image" => "disaster-prevention/disaster-prevention/emergency-power.jpg",
        "image-width" => "308",
        "image-height" => "208",
...
$disaster_card_database = [
    "キッチン" =>  [
        [
            "id" => "01",
            "title" => "カセットガス<br>発電機",
            "detail" => "テキストテキストテキストテキストテキストテキストテキストテキスト",
            "notice" => "※注釈テキスト<br>※注釈テキスト"
        ],
        [
            "id" => "02",
            "title" => "まかないくん",
...
<section class="disaster-prevention-section">
    <div class="disaster-prevention-section_inner">
        <?php foreach ($disaster_prevention_database01 as $point) { ?>
            <?php get_template_part('components/common/point', null, ['point' => $point, 'page' => $args['page']]); ?>
        <?php } ?>
        <?php foreach ($disaster_card_database as $group => $disaster_cards) {
        ?>
            <div class="disaster-card-list">
                <?php
                foreach ($disaster_cards as $disaster_card) {
                    get_template_part('components/disaster-prevention/disaster-card', null, $disaster_card);
                }
                ?>
            </div>
        <?php } ?>
...
<section class="disaster-prevention-section">
    <div class="disaster-prevention-section_inner">
        <div class="disaster-prevention_information">
            <h2 class="disaster-prevention_heading">安心を幾重にも重ねるセキュリティ。</h2>
            <p class="disaster-prevention_detail">基本的なライフラインの確保など、災害の時も変わりない日常を目指して、<br>様々な視点から安心を支える取り組みを行っています。</p>
        </div>
        <?php foreach ($disaster_prevention_database02 as $point) { ?>
            <?php get_template_part('components/common/point', null, ['point' => $point, 'page' => $args['page']]); ?>
        <?php } ?>
    </div>
</section>
<section class="disaster-prevention-section">
    <div class="disaster-prevention-section_inner">
        <div class="disaster-prevention_information">
            <h2 class="disaster-prevention_heading">防災体制</h2>
            <p class="disaster-prevention_detail">テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト</p>
        </div>
        <?php foreach ($disaster_prevention_database03 as $point) { ?>
            <?php get_template_part('components/common/point', null, ['point' => $point, 'page' => $args['page']]); ?>
        <?php } ?>
    </div>
</section>