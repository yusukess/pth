    ...
    <section class="concept_point concept_point2">
        <div class="concept_point_inner">
            ...
            <div class="concept_point_description">
                <h3 class="concept_point_heading">晴海の水辺に面した住環境で、<br>都会を使いこなす</h3>
                <p class="concept_point_detail">
                    銀座まで直線距離約2.5㎞の距離という都心にありながら、晴海の運河に面し、<br class="for-pc">
                    まるで異国のリゾートのようなロケーションを実現。<br class="for-pc">
                    豊かな緑に囲まれた晴海臨海公園の遊歩道が広がる癒し空間です。<br class="for-pc">
                    夜には豊洲エリアを一望できる煌びやかな夜景も。<br class="for-pc">
                    心安らぐ風景と都市の調和性が調和した最高福の暮らしがここに―。
                </p>
            </div>
        </div>
    </section>
    <section class="concept_point concept_point3">
        ...
        <?php echo(default_image( array('top/moving-photo/photo10.jpg'), '800', '650', '', 'photo' )); ?>
            <div class="concept_point_description">
                ...
                <p class="concept_point_detail">
                    大規模ならではの豊富な共用空間も魅力です。<br class="for-pc">
                    例えば、バーベキュー施設で友人や家族と楽しいひとときを過ごし、<br class="for-pc">
                    船のデッキでくつろぐような読書スペースでは、静寂の中で心を落ち着かせることも。<br class="for-pc">
                    さらに、バスケットコートやフットサルコートも併設。<br class="for-pc">
                    その他にも住民の方の個性あふれるライフスタイルを豊かに彩ります。<br class="for-pc">
                </p>
            </div>
        </div>
    </section>
    <section class="concept_point concept_point4">
        <div class="concept_point_inner">
            ...
            <div class="concept_point_description">
                ...
                <p class="concept_point_detail">
                    シングル、ディンクス、子育て世代、シニア、国籍を問わず、さまざまな背景を持つ<br class="for-pc">
                    人々が共に輝き、心地よく自由に暮らせる環境が整っています。<br class="for-pc">
                    例えば、子育て世代の方が求める教育環境はもちろん、<br class="for-pc">
                    憩い・仕事・遊び・学び・趣味といった、多様な方に愛される住空間となっています。<br class="for-pc">
                </p>
            </div>
        </div>
    </section>
