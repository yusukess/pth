    ...
    <section class="concept_point concept_point3">
        ...
        <div class="concept_point_inner">
            ...
            <div class="concept_point_description">
                ...
                <p class="concept_point_detail">
                    大規模ならではの豊富な共用空間も魅力です。<br>
                    例えば、バーベキュー施設で友人や家族と楽しいひとときを過ごし、<br>
                    船のデッキでくつろぐような読書スペースでは、静寂の中で心を落ち着かせることも。<br>
    ...
    <section class="concept_point concept_point4">
        <div class="concept_point_inner">
            ...
            <div class="concept_point_description">
                ...
                <p class="concept_point_detail">
                    シングル、ディンクス、子育て世代、シニア、国籍を問わず、さまざまな背景を持つ<br>
                    人々が共に輝き、心地よく自由に暮らせる環境が整っています。<br>
                    例えば、子育て世代の方が求める教育環境はもちろん、<br>
