...
<section class="kv-section <?php echo ($args["page"]); ?>">
    ...
    <?php if ($args["page"] === "index") { ?>
        ...
        <div class="kv slider-kv">
            <?php echo (default_image(array('kv/top01.jpg'), '1600', '800', 'top')); ?>
            <?php echo (default_image(array('kv/top02.jpg'), '1600', '800', 'top')); ?>
            <?php echo (default_image(array('kv/top03.jpg'), '1600', '800', 'top')); ?>
        </div>
    <?php } else { ?>
